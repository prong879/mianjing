...
这类题最好不要泛泛说“我会用 AI 写代码”，而要说清楚你把 AI 用在了哪些环节。
...
#### 9. Python 数据处理题：找出每个月换电次数排名前十的用户
...
#### 10. pandas 处理题：两列不同口径字段合并成一列并保留最大值
